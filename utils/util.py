...
def draw_heatmap(raw: np.ndarray):
    """
    For color maps, please check https://docs.opencv.org/4.x/d3/d50/group__imgproc__colormap.html for details.
    Params:
        raw (np.ndarray): `H * W`
    ...
    """
    heatmapshow = cv2.normalize(raw, None, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_8U)
